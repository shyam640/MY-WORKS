...
import com.example.cooltalks.ViewsFolder.MessageView;
import com.example.cooltalks.databinding.ActivityMessagePageBinding;
...
public class MessagePage extends AppCompatActivity {
    ActivityMessagePageBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Glide.with(MessagePage.this).load(profile)
                .placeholder(R.drawable.avatar)
                .into(binding.chatprofileimage);

        binding.chatprofileimage.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        adapter = new MessageView(this,messages,senderRoom,receiverRoom);
...
//        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.chat_style, menu);
